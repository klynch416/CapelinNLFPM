...
p3 <- ggplot() +
  ...
  scale_color_manual(name = "Species Model", values = c(all = "black", surv = "#BB2D05", ap = "#FF7733", gh = "#048BA8"),
                     labels = c(all = "All species", surv = "Acoustic survey", ap = "Plaice", gh = "Greenland halibut")) +
...
p4 <- ggplot() +
  ...
  scale_color_manual(name = "Species Model", values = c(all = "black", ac = "#BC8DA0", gh = "#048BA8"),
                     labels = c(all = "All species", ac = "Cod/ Plaice", gh = "Greenland halibut")) +
  guides(colour = guide_legend(keyheight = 0.4, default.unit = "cm")) +
  ggtitle("e) Fall") +
  theme_classic() +
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), panel.background = element_blank(),
...
p5 <- ggplot() +
  ...
  scale_color_manual(name = "Species Model", values = c(all = "black", surv = "#BB2D05", ac = "#BC8DA0", gh = "#048BA8"),
                     labels = c(all = "All species", surv = "Acoustic survey", ac = "Cod/ Plaice", gh = "Greenland halibut")) +
  guides(colour = guide_legend(keyheight = 0.4, default.unit = "cm")) +
  ggtitle("c) Spring") +
  theme_classic() +
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), panel.background = element_blank(),
...
p6 <- ggplot() +
  ...
  geom_line(aes(x = 0, y = 0, colour = "ap"), size = 1.5) +
  geom_point(aes(x = 0, y = 0, colour = "ap"), size = 1.5) +
  ...
  scale_color_manual(name = "Species Model", values = c(all = "black", ac = "#BC8DA0", gh = "#048BA8", ap = "#FF7733"),
                     labels = c(all = "All species", ac = "Cod/ Plaice", gh = "Greenland halibut", ap = "American plaice")) +
  guides(colour = guide_legend(keyheight = 0.4, default.unit = "cm")) +
  ggtitle("f) Fall") +
  theme_classic() +
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), panel.background = element_blank(),
...
p7 <- ggarrange(p1+theme(axis.title.x = element_blank()),
          ...
          nrow = 3, ncol = 2,
          align = "v", legend = "right", legend.grob = ggpubr::get_legend(p6+theme(legend.position = "right")))
...
p8 <- ggplot(data = lr_dat, aes(x = NLFPM_bm, y = acc_bm)) +
  ...
  theme(
    ...
    legend.position = "none",
    legend.text = element_text(size = 9), legend.title = element_text(size = 11, face = "bold"),
    axis.text =  element_text(size = 11), axis.title = element_text(size = 13, face = "bold"),
...
```{r}
p18 <- ggplot(data = lr_dat, aes(x = l_NLFPM_bm, y = jkl_NLFPM_bm)) +
  geom_smooth(method = "lm", se = TRUE, color = "darkgrey") +
  geom_point(aes(colour = year), size = 1.5) +

  scale_x_continuous(name = "3L NLFPM Abundance Index", expand = c(0.005,0)) +
  scale_y_continuous(name = "2J3KL NLFPM Abundance Index", expand = c(0.01,0)) +
  scale_colour_gradient2(name = "Year", limits = c(1995,2021), midpoint = 2007,  low = "blue", mid = "#FFAEFF", high = "red") +
  theme_classic() +
  theme(
    panel.grid.major = element_blank(), panel.grid.minor = element_blank(), panel.background = element_blank(),   
...
ggsave(filename = "spatialcomp.tiff", device = "tiff", plot = p18, path = "./Figures",
