...
sample_size <- data.frame(
  ...
  E.pemptycapelin =  c(nrow(filter(Tac0, geartype == "engel" & pa == "0"))/nrow(filter(Tac0, geartype == "engel"))*100,
  ...
  E.pempty =  c(nrow(filter(Tac0, geartype == "engel" & empty == "1"))/nrow(filter(Tac0, geartype == "engel"))*100,
  ...
  C.pempty =  c(nrow(filter(Tac0, geartype == "campelen" & empty == "1"))/nrow(filter(Tac0, geartype == "campelen"))*100,
...
write.csv(x = sample_size, file = "./samplesize-fixed.csv")
