...
Eacf0 <- AC_stof %>% filter(length < 18) %>% filter(year == 1982 & year == 1983 & year == 1988)
...
ac <- data.frame(year = seq(1984,2020,1), 
                 ...
                 ac0_fall = c(rep(0,11), dfac0$ac0_fall[1:16], 0, dfac0$ac0_fall[17:24], rep(0,1)),
...
sample_size <- data.frame(
  ...
  C.pempty =  c(nrow(filter(Tac0, geartype == "campelen" & pa == "0"))/nrow(filter(Tac0, geartype == "campelen"))*100,
...
sample_size <- sample_size %>% mutate(E.pempty = format(E.pempty, digits = 4), C.pempty = format(C.pempty, digits = 4))
